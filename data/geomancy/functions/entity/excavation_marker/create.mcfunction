...
execute as @e[type=armor_stand,distance=..0.1,tag=geomancy.exMarker] unless score @s smithed.id matches -2147483648..2147483647 run scoreboard players operation @s smithed.id = $temp smithed.id
