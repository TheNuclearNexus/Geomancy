...
# If one exists
if score $temp geomancy.data matches 1.. item modify entity @s weapon.mainhand geomancy:technical/remove_one
...
function #geomancy:item/sandpaper/sand
# If one exists
if score $temp geomancy.data matches 1.. item modify entity @s weapon.offhand geomancy:technical/remove_one
